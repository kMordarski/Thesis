...
is not optimal, even though players act in their own best interest. \\
\begin{center}
\begin{game}{2}{2}
  & $C$    & $D$    \\
$C$ & $R,R$ & $T,S$  \\
...
players. It doesn't make the deflection strategy totally inapplicable, but payoffs of this game favourizes cooperative behaviours more than the PD.  \\
\begin{center}
  \begin{game}{2}{2}
    & $C$    & $D$    \\
  $C$ & $R,R$ & $T,S$  \\
