...
\begin{enumerate}
  ...
  payoffs, and the SF NOC. It identifies all neighbors of the previously mentioned vertex, then shuffles all of its neighbors, and then looks for a neighbor
...
used by players. To run properly it requires previously set parametrization and a set of edges of the Barabassi-Albert graph. As an end result it produces a vector of length 
100 in which elements are proportions of coop/def strategies, after each generation (1001-1100) in population of players. 
