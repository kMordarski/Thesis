...
wLet $S_i$ be be the set of all possible strategies for player $i$, $s^* = (s^*_i, s_{-i}^*)$ be a strategy profile (set containing one strategy for each player --- $s_{-1}^*$ denotes strategies of all the other players except of $i$).
...
The game introduced by R. Duncan Luce and Howard Raiffa in their book \cite{luce1989games}. 
